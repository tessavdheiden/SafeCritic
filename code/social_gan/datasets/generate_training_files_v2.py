...
# whereas in the train and val folder there will be all other video scene annotations splitted (bookstore_1, bookstore_2, bookstore_3) (eg. bookstore_1 will be stored in both
...
'''
this is the directory where are various datasets data (example: "/home/userName/Desktop/FLORA/code/social_gan/datasets/safeGAN_dataset/")
- safeGAN_dataset
   -SDD
      -bookstore_0
      -coupa_0
   ...
   -UCY
'''
dataset_folder = "/home/user/Desktop/FLORA/code/social_gan/datasets/safegan_dataset/"
dataset = "SDD"
test_scene = "nexus_9"
...
for root, dirs, files in os.walk(dataset_folder+dataset+"/"):
    if root != dataset_folder+dataset+"/":
        continue;
    for scene in dirs:
        if scene != test_scene and test_scene.split("_")[0] in scene:
