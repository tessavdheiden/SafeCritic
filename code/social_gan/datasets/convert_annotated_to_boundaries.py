...
dir_dataset = "/home/q467565/Desktop/FLORA/code/social_gan/datasets/stanford_drone_dataset/SDD/"
...
for root, dirs, files in os.walk(dir_dataset):
    ...
    for scene_folder in dirs:
        if scene_folder != 'quad_3':
            continue
        print("\n*****scene_folder:\n", scene_folder)
        annotated_image_path = root + scene_folder + "/" + "scene_information/annotated.jpg"
        ...
        cv2.imwrite(root + scene_folder + "/" + "scene_information/annotated_boundaries.jpg", boundary_image)
