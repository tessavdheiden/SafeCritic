...
<<<<<<< HEAD:code/social_gan/sgan/context/static_pooling.py
import os
import numpy as np
import pandas as pd
...
from static_scene_feature_extractor import StaticSceneFeatureExtractor
from sgan.static_pooling_algorithms import repeat, make_mlp
...
class PoolHiddenNet(nn.Module):
    ...
    def forward(self, h_states, seq_start_end, end_pos, rel_pos):
        ...
        for _, (start, end) in enumerate(seq_start_end):
            ...
            curr_end_pos_2 = repeat(curr_end_pos, num_ped)
            ...
            if self.pooling_dim == 4:
                ...
                # Repeat position -> P1, P1, P2, P2
                curr_disp_2 = repeat(curr_disp, num_ped)
...
>>>>>>> 81c919fe1de6ec1800cec505879f6d3e71bc3663:code/social_gan/sgan/pooling.py
...
<<<<<<< HEAD:code/social_gan/sgan/context/static_pooling.py
        ...
        if self.pool_static_type == 'random_cnn':
            ...
            self.spatial_embedding = nn.Linear(2 * self.num_cells, embedding_dim).cuda()
            self.mlp_pre_pool = make_mlp(mlp_pre_pool_dims, activation=activation, batch_norm=batch_norm, dropout=dropout).cuda()
...
>>>>>>> 81c919fe1de6ec1800cec505879f6d3e71bc3663:code/social_gan/sgan/pooling.py
    ...
    def get_context_information(self, h_states, seq_start_end, end_pos, rel_pos, seq_scene_ids):
        """
        Inputs:
        - h_states: Tensor of shape (num_layers, batch, h_dim)
        - seq_start_end: A list of tuples which delimit sequences within batch
...
class SocialPooling(nn.Module):
    ...
    def forward(self, h_states, seq_start_end, end_pos, rel_pos):
        ...
        for _, (start, end) in enumerate(seq_start_end):
            ...
            top_left = repeat(top_left, num_ped)
            bottom_right = repeat(bottom_right, num_ped)
            ...
            offset = repeat(offset.view(-1, 1), num_ped).view(-1)
            grid_pos += offset
